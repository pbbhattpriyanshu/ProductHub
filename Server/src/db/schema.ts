...
//TODO: Explain the Relations later
...
export const productRelations = relations(products, ({one, many}) => ({
    ...
    //'reference' = the primary key column in the related table (user.id) 
...
//COMMENTS RELATIONS: A comments belongs to one user and one product
